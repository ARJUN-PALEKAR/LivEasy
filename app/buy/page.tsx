...
export default function BuyPage() {
  ...
  useEffect(() => {
    ...
    // Parse saved properties to get only properties added via sell page (they have id >= 100 or are new listings)
    const userAddedProperties = savedProperties ? JSON.parse(savedProperties).filter((p) => p.id >= 100) : []
    // Start with hardcoded initialProperties and add only new user-listed properties
    const allProperties = [...initialProperties, ...userAddedProperties]
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 pt-4 sm:pt-8 gap-4">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-2xl sm:text-4xl font-bold text-white">Find LivEasy Housing</h1>
          </div>
