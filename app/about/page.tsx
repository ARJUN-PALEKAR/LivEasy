    ...
    <div className="min-h-screen p-3 sm:p-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-6 sm:mb-8 pt-4 sm:pt-8">
          ...
          <h1 className="text-2xl sm:text-4xl font-bold text-white">About LivEasy</h1>
        </div>

        {/* Hero Section */}
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-white mb-4">About LivEasy</h2>
        ...
        <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-8 text-center">
          ...
          <p className="text-gray-300 mb-6">
            Join thousands of students who have found their perfect home through LivEasy.
          </p>
