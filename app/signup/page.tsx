      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="bg-green-500/20 border border-green-500/30 rounded-lg p-8 text-center">
            ...
            <p className="text-green-300 mb-4">Welcome to LivEasy! You can now login with your credentials.</p>
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm sm:text-base">Join LivEasy and find your perfect home</p>
        </div>
